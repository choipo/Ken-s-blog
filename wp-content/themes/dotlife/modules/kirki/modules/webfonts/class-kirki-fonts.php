...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_attr__( 'Ultra-Light 100', 'dotlife' ),
			'100light'  => esc_attr__( 'Ultra-Light 100', 'dotlife' ),
			'100italic' => esc_attr__( 'Ultra-Light 100 Italic', 'dotlife' ),
			'200'       => esc_attr__( 'Light 200', 'dotlife' ),
			'200italic' => esc_attr__( 'Light 200 Italic', 'dotlife' ),
			'300'       => esc_attr__( 'Book 300', 'dotlife' ),
			'300italic' => esc_attr__( 'Book 300 Italic', 'dotlife' ),
			'400'       => esc_attr__( 'Normal 400', 'dotlife' ),
			'regular'   => esc_attr__( 'Normal 400', 'dotlife' ),
			'italic'    => esc_attr__( 'Normal 400 Italic', 'dotlife' ),
			'500'       => esc_attr__( 'Medium 500', 'dotlife' ),
			'500italic' => esc_attr__( 'Medium 500 Italic', 'dotlife' ),
			'600'       => esc_attr__( 'Semi-Bold 600', 'dotlife' ),
			'600bold'   => esc_attr__( 'Semi-Bold 600', 'dotlife' ),
			'600italic' => esc_attr__( 'Semi-Bold 600 Italic', 'dotlife' ),
			'700'       => esc_attr__( 'Bold 700', 'dotlife' ),
			'700italic' => esc_attr__( 'Bold 700 Italic', 'dotlife' ),
			'800'       => esc_attr__( 'Extra-Bold 800', 'dotlife' ),
			'800bold'   => esc_attr__( 'Extra-Bold 800', 'dotlife' ),
			'800italic' => esc_attr__( 'Extra-Bold 800 Italic', 'dotlife' ),
			'900'       => esc_attr__( 'Ultra-Bold 900', 'dotlife' ),
			'900bold'   => esc_attr__( 'Ultra-Bold 900', 'dotlife' ),
			'900italic' => esc_attr__( 'Ultra-Bold 900 Italic', 'dotlife' ),
		);
	}
