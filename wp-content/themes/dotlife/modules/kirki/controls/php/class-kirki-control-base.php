...
class Kirki_Control_Base extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_localize_script(
			...
			'kirkiL10n',
			array(
				'noFileSelected' => esc_attr__( 'No File Selected', 'dotlife' ),
				'remove'         => esc_attr__( 'Remove', 'dotlife' ),
				'default'        => esc_attr__( 'Default', 'dotlife' ),
				'selectFile'     => esc_attr__( 'Select File', 'dotlife' ),
				'standardFonts'  => esc_attr__( 'Standard Fonts', 'dotlife' ),
				'googleFonts'    => esc_attr__( 'Google Fonts', 'dotlife' ),
			)
		);
