 ...
 * @since 1.0.0
 */
class DotLife_Gallery_Grid extends Widget_Base {
	...
	public function get_title() {
		return __( 'Grid Gallery', 'dotlife-elementor' );
	}
	...
	protected function render() {
		include(DOTLIFE_ELEMENTOR_PATH.'templates/gallery-grid/index.php');
	}
