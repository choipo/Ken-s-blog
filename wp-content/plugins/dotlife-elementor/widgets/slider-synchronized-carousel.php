 ...
 * @since 1.0.0
 */
class DotLife_Slider_Synchronized_Carousel extends Widget_Base {
	...
	public function get_name() {
		return 'dotlife-slider-synchronized-carousel';
	}
	...
	public function get_title() {
		return __( 'Synchronized Carousel Slider', 'dotlife-elementor' );
	}
	...
	public function get_script_depends() {
		return [ 'momentum-slider', 'dotlife-elementor' ];
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			array(
				'label'      => esc_html__( 'Number', 'dotlife-elementor' ),
		...
		$this->add_control(
		    'number_color',
		    [
		        'label' => __( 'Number Color', 'dotlife-elementor' ),
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Number Typography', 'dotlife-elementor' ),
	...
	protected function render() {
		include(DOTLIFE_ELEMENTOR_PATH.'templates/slider-synchronized-carousel/index.php');
	}
