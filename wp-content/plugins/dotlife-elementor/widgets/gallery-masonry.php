 ...
 * @since 1.0.0
 */
class DotLife_Gallery_Masonry extends Widget_Base {
	...
	public function get_name() {
		return 'dotlife-gallery-masonry';
	}
	...
	public function get_title() {
		return __( 'Masonry Gallery', 'dotlife-elementor' );
	}
	...
	public function get_script_depends() {
		return [ 'tilt', 'masonry', 'dotlife-elementor' ];
	}
	...
	protected function render() {
		include(DOTLIFE_ELEMENTOR_PATH.'templates/gallery-masonry/index.php');
	}
