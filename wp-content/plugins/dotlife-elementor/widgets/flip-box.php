 ...
 * @since 1.0.0
 */
class DotLife_Flip_Box extends Widget_Base {
	...
	public function get_title() {
		return __( 'Flip Box', 'dotlife-elementor' );
	}
	...
	public function get_script_depends() {
		return [ 'tweenmax', 'dotlife-elementor' ];
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
		    'default_image',
		    [
		        'label' => __( 'Default Background Image', 'dotlife-elementor' ),
		...
		$this->add_control(
		    'default_title',
		    [
		        'label' => __( 'Default Title', 'dotlife-elementor' ),
		...
		$this->add_control(
		    'default_description',
		    [
		        'label' => __( 'Default Description', 'dotlife-elementor' ),
		...
		$this->add_control(
		    'flip_image',
		    [
		        'label' => __( 'Flip Background Image', 'dotlife-elementor' ),
		        'type' => Controls_Manager::MEDIA,
		    ]
		);
		...
		$this->add_control(
		    'flip_title',
		    [
		        'label' => __( 'Flip Title', 'dotlife-elementor' ),
		        'type' => Controls_Manager::TEXT,
		    ]
		);
		...
		$this->add_control(
		    'flip_button_title',
		    [
		        'label' => __( 'Flip Button Title', 'dotlife-elementor' ),
		        'type' => Controls_Manager::TEXT,
		    ]
		);
		...
		$this->add_control(
		    'flip_button_link',
		    [
		        'label' => __( 'Flip Button Link', 'dotlife-elementor' ),
		...
		$this->add_control(
		    'content_bg_color',
		    [
		        'label' => __( 'Overlay Background Color', 'dotlife-elementor' ),
		...
		$this->start_controls_section(
			...
			array(
				'label'      => esc_html__( 'Default Content', 'dotlife-elementor' ),
		...
		$this->add_control(
		    'default_title_color',
		    [
		        'label' => __( 'Default Title Color', 'dotlife-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#ffffff',
		        'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Default Title Typography', 'dotlife-elementor' ),
		...
		$this->add_control(
		    ...
		    [
		        'label' => __( 'Default Description Color', 'dotlife-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#ffffff',
		        'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Default Description Typography', 'dotlife-elementor' ),
		...
		$this->start_controls_section(
			...
			array(
				'label'      => esc_html__( 'Flip Content', 'dotlife-elementor' ),
				'tab'        => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			)
		);
		...
		$this->add_control(
		    'flip_title_color',
		    [
		        'label' => __( 'Flip Title Color', 'dotlife-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#ffffff',
		        'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Flip Title Typography', 'dotlife-elementor' ),
		...
		$this->add_control(
		    'button_bg_color',
		    [
		        'label' => __( 'Flip Button Background Color', 'dotlife-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#0067DA',
		        'selectors' => [
		...
		$this->add_control(
		    'button_font_color',
		    [
		        'label' => __( 'Flip Button Font Color', 'dotlife-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#ffffff',
		        'selectors' => [
		...
		$this->add_control(
		    ...
		    [
		        'label' => __( 'Flip Button Hover Background Color', 'dotlife-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#ffffff',
		        'selectors' => [
		...
		$this->add_control(
		    ...
		    [
		        'label' => __( 'Flip Button Hover Font Color', 'dotlife-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#222222',
		        'selectors' => [
	...
	protected function render() {
		include(DOTLIFE_ELEMENTOR_PATH.'templates/flip-box/index.php');
	}
