 ...
 * @since 1.0.0
 */
class DotLife_Slider_Room extends Widget_Base {
	...
	public function get_title() {
		return __( 'Fullscreen 3D Room Slider', 'dotlife-elementor' );
	}
		...
		$this->add_control(
			...
			[
				...
				'fields' => [
					[
						'name' => 'slide_image',
						'label' => __( 'Image (max. 8)', 'dotlife-elementor' ),
	...
	protected function render() {
		include(DOTLIFE_ELEMENTOR_PATH.'templates/slider-room/index.php');
	}
