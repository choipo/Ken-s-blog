 ...
 * @since 1.0.0
 */
class DotLife_Horizontal_Timeline extends Widget_Base {
	...
	public function get_name() {
		return 'dotlife-horizontal-timeline';
	}
	...
	public function get_title() {
		return __( 'Horizontal Timeline', 'dotlife-elementor' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
		    'nav_label_color',
		    [
		        'label' => __( 'Navigation Label Color', 'dotlife-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#000000',
		        'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Navigation Label Typography', 'dotlife-elementor' ),
	...
	protected function render() {
		include(DOTLIFE_ELEMENTOR_PATH.'templates/horizontal-timeline/index.php');
	}
