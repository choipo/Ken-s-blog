 ...
 * @since 1.0.0
 */
class DotLife_Slider_Velo extends Widget_Base {
	...
	public function get_title() {
		return __( 'Fullscreen Velo Slider', 'dotlife-elementor' );
	}
	...
	public function get_script_depends() {
		return [ 'velocity', 'velocity-ui', 'dotlife-elementor' ];
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'expand',
			[
				'label' => __( 'Expand Image by Default', 'dotlife-elementor' ),
		...
		$this->add_control(
		    'background_overlay',
		    [
		        'label' => __( 'Background Overlay Color', 'dotlife-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => 'rgba(0,0,0,0.2)',
		        'selectors' => [
		            '{{WRAPPER}} .tg_velo_slide_container .velo-slide__bg:after' => 'background: {{VALUE}}',
		        ],
		    ]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .tg_velo_slide_container h2.velo-slide__title',
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .tg_velo_slide_container .velo-slide__text',
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .tg_velo_slide_container .btn-draw.btn--white .btn-draw__text',
			]
		);
	...
	protected function render() {
		include(DOTLIFE_ELEMENTOR_PATH.'templates/slider-velo/index.php');
	}
