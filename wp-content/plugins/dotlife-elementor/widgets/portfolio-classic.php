 ...
 * @since 1.0.0
 */
class DotLife_Portfolio_Classic extends Widget_Base {
	...
	public function get_name() {
		return 'dotlife-portfolio-classic';
	}
	...
	public function get_title() {
		return __( 'Portfolio Classic', 'dotlife-elementor' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
		    'portfolio_bg_color',
		    [
		        'label' => __( 'Portfolio Content Background Color', 'dotlife-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#ffffff',
		        'selectors' => [
		            '{{WRAPPER}} .portfolio_classic_content_wrapper .portfolio_classic_content' => 'background: {{VALUE}}',
		        ],
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'selectors' => [
		            ...
		            '{{WRAPPER}} .portfolio_classic_content h3.portfolio_classic_title a' => 'color: {{VALUE}}',
		            '{{WRAPPER}} .portfolio_classic_content h3.portfolio_classic_title a:hover' => 'color: {{VALUE}}',
		        ],
		    ]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} div.portfolio_classic_content h3.portfolio_classic_title',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'toggle' => true,
				'selectors' => [
		            '{{WRAPPER}} div.portfolio_classic_content h3.portfolio_classic_title' => 'text-align: {{VALUE}}',
		            '{{WRAPPER}} div.portfolio_classic_content .portfolio_classic_subtitle' => 'text-align: {{VALUE}}',
		        ],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .portfolio_classic_grid_wrapper .portfolio_classic_content .portfolio_classic_subtitle',
			]
		);
	...
	protected function render() {
		include(DOTLIFE_ELEMENTOR_PATH.'templates/portfolio-classic/index.php');
	}
