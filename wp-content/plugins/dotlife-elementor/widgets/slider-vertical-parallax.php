 ...
 * @since 1.0.0
 */
class DotLife_Slider_Vertical_Parallax extends Widget_Base {
	...
	public function get_name() {
		return 'dotlife-slider-vertical-parallax';
	}
	...
	public function get_title() {
		return __( 'Fullscreen Vertical Parallax Slider', 'dotlife-elementor' );
	}
	...
	public function get_script_depends() {
		return [ 'lodash', 'dotlife-elementor' ];
	}
	...
	protected function _register_controls() {
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .tg_parallax_slide_content_title h2',
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .tg_parallax_slide_content_subtitle',
			]
		);
	...
	protected function render() {
		include(DOTLIFE_ELEMENTOR_PATH.'templates/slider-vertical-parallax/index.php');
	}
