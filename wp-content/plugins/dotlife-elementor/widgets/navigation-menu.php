 ...
 * @since 1.0.0
 */
class DotLife_Navigation_Menu extends Widget_Base {
	...
	public function get_name() {
		return 'dotlife-navigation-menu';
	}
	...
	public function get_title() {
		return __( 'Theme Navigation Menu', 'dotlife-elementor' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_parent_menu',
			[
				'label' => __( 'Parent Menu', 'dotlife-elementor' ),
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Typography', 'dotlife-elementor' ),
		...
		$this->start_controls_section(
			'section_sub_menu',
			[
				'label' => __( 'Sub Menu', 'dotlife-elementor' ),
			]
		);
		...
		$this->add_control(
			'nav_sub_menu_margin',
			[
				'label' => __( 'Padding', 'dotlife-elementor' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px' ],
				'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Box Shadow', 'dotlife-elementor' ),
		...
		$this->start_controls_section(
			'section_menu_style',
			array(
				'label'      => esc_html__( 'Parent Menu Colors', 'dotlife-elementor' ),
		...
		$this->add_control(
		    'nav_menu_font_color',
		    [
		        'label' => __( 'Font Color', 'dotlife-elementor' ),
		...
		$this->add_control(
		    ...
		    [
		        'label' => __( 'Hover Font Color', 'dotlife-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#0067DA',
		        'selectors' => [
		...
		$this->add_control(
		    ...
		    [
		        'label' => __( 'Hover Border Color', 'dotlife-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#0067DA',
		        'selectors' => [
		...
		$this->add_control(
		    ...
		    [
		        'label' => __( 'Active Font Color', 'dotlife-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#0067DA',
		        'selectors' => [
		...
		$this->add_control(
		    ...
		    [
		        'label' => __( 'Active Border Color', 'dotlife-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#0067DA',
		        'selectors' => [
		...
		$this->start_controls_section(
			...
			array(
				'label'      => esc_html__( 'Sub Menu Colors', 'dotlife-elementor' ),
				'tab'        => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			)
		);
	...
	protected function render() {
		include(DOTLIFE_ELEMENTOR_PATH.'templates/navigation-menu/index.php');
	}
