 ...
 * @since 1.0.0
 */
class DotLife_Slider_Zoom extends Widget_Base {
	...
	public function get_title() {
		return __( 'Zoom Slider', 'dotlife-elementor' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
		    'content_background',
		    [
		        'label' => __( 'Content Background', 'dotlife-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#222222',
		        'selectors' => [
		...
		$this->add_responsive_control(
		    'title_width',
		    [
		        'label' => __( 'Title Width', 'dotlife-elementor' ),
		        'type' => Controls_Manager::SLIDER,
		        'default' => [
		            'size' => 50,
		        ],
		...
		$this->add_responsive_control(
		    'title_margintop',
		    [
		        'label' => __( 'Title Margin Top (in px)', 'dotlife-elementor' ),
		        'type' => Controls_Manager::SLIDER,
		        'default' => [
		            'size' => 45,
		        ],
		        ...
		        'size_units' => [ 'px' ],
		        'selectors' => [
		            '{{WRAPPER}} .slideshow__slide-caption-text' => 'padding-top: {{SIZE}}px;',
		        ],
		    ]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} h1.slideshow__slide-caption-title',
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .slideshow__slide-caption-text div.slideshow__slide-desc',
			]
		);
	...
	protected function render() {
		include(DOTLIFE_ELEMENTOR_PATH.'templates/slider-zoom/index.php');
	}
