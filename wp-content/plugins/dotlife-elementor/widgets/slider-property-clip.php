 ...
 * @since 1.0.0
 */
class DotLife_Slider_Property_Clip extends Widget_Base {
	...
	public function get_name() {
		return 'dotlife-slider-property-clip';
	}
	...
	public function get_title() {
		return __( 'Property Clip Slider', 'dotlife-elementor' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'image_align',
			[
				'label' => __( 'Image Alignment', 'dotlife-elementor' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'left',
			    'options' => [
		...
		$this->add_control(
		  ...
		  [
		     ...
		     'placeholder' => __( 'Title', 'dotlife-elementor' ),
		  ]
		);
		...
		$this->add_control(
		  ...
		  [
		     ...
		     'type'        => Controls_Manager::TEXT,
		     'placeholder' => __( 'Sub Title', 'dotlife-elementor' ),
		  ]
		);
		...
		$this->add_control(
		  ...
		  [
		     ...
		     'default' => __( 'Default description', 'dotlife-elementor' ),
		  ]
		);
	...
	protected function render() {
		include(DOTLIFE_ELEMENTOR_PATH.'templates/slider-property-clip/index.php');
	}
