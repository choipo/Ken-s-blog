 ...
 * @since 1.0.0
 */
class DotLife_Portfolio_Grid extends Widget_Base {
	...
	public function get_title() {
		return __( 'Portfolio Grid', 'dotlife-elementor' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'default' => '#ffffff',
		        'selectors' => [
		            '{{WRAPPER}} .portfolio_grid_wrapper:before' => 'border-color: {{VALUE}}',
		            '{{WRAPPER}} .portfolio_grid_wrapper:after' => 'border-color: {{VALUE}}',
		        ],
		    ]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} div.portfolio_grid_wrapper h3',
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .portfolio_grid_wrapper figcaption div.portfolio_grid_subtitle',
			]
		);
	...
	protected function render() {
		include(DOTLIFE_ELEMENTOR_PATH.'templates/portfolio-grid/index.php');
	}
