 ...
 * @since 1.0.0
 */
class DotLife_Slider_Image_Carousel extends Widget_Base {
	...
	public function get_name() {
		return 'dotlife-slider-image-carousel';
	}
	...
	public function get_title() {
		return __( 'Image Carousel Slider', 'dotlife-elementor' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_responsive_control(
		    ...
		    [
		        ...
		        'size_units' => [ 'px' ],
		        'selectors' => [
		            '{{WRAPPER}} .tg_image_carousel_slider_wrapper.carousel' => 'height: {{SIZE}}{{UNIT}};',
		        ],
		    ]
		);
		...
		$this->add_responsive_control(
		    'content_padding',
		    [
		        'label' => __( 'Content Padding (in px)', 'dotlife-elementor' ),
		        'type' => Controls_Manager::SLIDER,
		        'default' => [
		            'size' => 90,
		        ],
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'default' => '#000000',
		        'selectors' => [
		            '{{WRAPPER}} div.tg_image_carousel_slider_wrapper.carousel .carousel-item .carousel-item__title' => 'color: {{VALUE}}',
		        ],
		    ]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .tg_image_carousel_slider_wrapper.carousel .carousel-item .carousel-item__title',
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .tg_image_carousel_slider_wrapper.carousel .carousel-item h2.carousel-item__subtitle',
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .tg_image_carousel_slider_wrapper.carousel .carousel-item .carousel-item__info .carousel-item__description',
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .tg_image_carousel_slider_wrapper.carousel .carousel-item a.carousel-item__btn',
			]
		);
	...
	protected function render() {
		include(DOTLIFE_ELEMENTOR_PATH.'templates/slider-image-carousel/index.php');
	}
