 ...
 * @since 1.0.0
 */
class DotLife_Distortion_Grid extends Widget_Base {
	...
	public function get_name() {
		return 'dotlife-distortion-grid';
	}
	...
	public function get_title() {
		return __( 'Distortion Hover Grid', 'dotlife-elementor' );
	}
	...
	public function get_script_depends() {
		return [ 'imagesloaded', 'three', 'tweenmax', 'hover', 'dotlife-elementor' ];
	}
	...
	protected function _register_controls() {
			...
			[
				...
				'fields' => [
					...
					[
						...
						'label' => __( 'Image on hover', 'dotlife-elementor' ),
						'type' => Controls_Manager::MEDIA,
						'label_block' => true,
					],
					[
					...
					[
						'name' => 'slide_excerpt',
						'label' => __( 'Excerpt', 'dotlife-elementor' ),
						'type' => Controls_Manager::TEXTAREA,
						'default' => __( 'Excerpt' , 'dotlife-elementor' ),
					],
					[
						'name' => 'slide_link_title',
						'label' => __( 'Link Title', 'dotlife-elementor' ),
						'type' => Controls_Manager::TEXT,
						'default' => __( 'Link Title' , 'dotlife-elementor' ),
					],
					[
						'name' => 'slide_link',
		...
		$this->add_control(
		  'theme',
		  [
		     'label'       => __( 'Theme', 'dotlife-elementor' ),
		     'type' => Controls_Manager::SELECT,
		     'default' => 1,
		     'options' => [
			   1 => __( 'Theme 1', 'dotlife-elementor' ),
			   2 => __( 'Theme 2', 'dotlife-elementor' ),
			   3 => __( 'Theme 3', 'dotlife-elementor' ),
			   4 => __( 'Theme 4', 'dotlife-elementor' ),
			   5 => __( 'Theme 5', 'dotlife-elementor' ),
			   6 => __( 'Theme 6', 'dotlife-elementor' ),
			   7 => __( 'Theme 7', 'dotlife-elementor' ),
			   8 => __( 'Theme 8', 'dotlife-elementor' ),
			   9 => __( 'Theme 9', 'dotlife-elementor' ),
			   10 => __( 'Theme 10', 'dotlife-elementor' ),
			],
		  ]
		);
	...
	protected function render() {
		include(DOTLIFE_ELEMENTOR_PATH.'templates/distortion-grid/index.php');
	}
