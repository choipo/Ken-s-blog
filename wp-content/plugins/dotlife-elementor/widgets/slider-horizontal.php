 ...
 * @since 1.0.0
 */
class DotLife_Slider_Horizontal extends Widget_Base {
	...
	public function get_name() {
		return 'dotlife-slider-horizontal';
	}
	...
	public function get_title() {
		return __( 'Horizontal Slider', 'dotlife-elementor' );
	}
	...
	public function get_script_depends() {
		return [ 'flickity', 'dotlife-elementor' ];
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'fields' => [
					[
						'name' => 'slide_image',
						'label' => __( 'Image (max. 3)', 'dotlife-elementor' ),
		...
		$this->start_controls_section(
			'section_options',
			[
				'label' => __( 'Options', 'dotlife-elementor' ),
			]
		);
		...
		$this->add_control(
			'fullscreen',
			[
				'label' => __( 'Fullscreen', 'dotlife-elementor' ),
		...
		$this->add_control(
		    'spacing',
		    [
		        'label' => __( 'Spacing (in px)', 'dotlife-elementor' ),
		        'type' => Controls_Manager::SLIDER,
		        'default' => [
		            'size' => 40,
		        ],
		...
		$this->add_control(
			'loop',
			[
				'label' => __( 'Loop', 'dotlife-elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'no',
				'label_on' => __( 'Yes', 'dotlife-elementor' ),
				'label_off' => __( 'No', 'dotlife-elementor' ),
		...
		$this->add_control(
		    'content_width',
		    [
		        'label' => __( 'Content Width (in %)', 'dotlife-elementor' ),
		        'type' => Controls_Manager::SLIDER,
		        'default' => [
		            'size' => 30,
		        ],
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} div.tg_horizontal_slide_content_title h2',
			]
		);
	...
	protected function render() {
		include(DOTLIFE_ELEMENTOR_PATH.'templates/slider-horizontal/index.php');
	}
