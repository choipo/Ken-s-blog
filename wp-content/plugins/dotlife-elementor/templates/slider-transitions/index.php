		    ...
		    <div class="swiper-image" data-swiper-parallax-y="35%">
	            <div class="swiper-image-inner swiper-image-right" style="background-image:url(<?php echo esc_url($slide['slide_image_right']['url']); ?>);">
					...
					<p class="paragraph">
						...
						?>
						<br class="clear"/><a class="tg_transitions_slide_content_link" href="<?php echo esc_url($slide['slide_link']['url']); ?>" <?php echo esc_attr($target); ?>><?php echo esc_html($slide['slide_link_title']); ?></a>
						<?php
							}
						?>	
					</p>
