	...
	if (have_posts()) : while (have_posts()) : the_post();
		...
		global $wp_query;
	   	...
	   	switch($settings['layout'])
	   	{
		   	case 'classic':
		   	default:
		   		include(DOTLIFE_ELEMENTOR_PATH.'/templates/blog-posts/classic.php');
		   	break;
		   	
		   	case 'grid':
		   		include(DOTLIFE_ELEMENTOR_PATH.'/templates/blog-posts/grid.php');
		   	break;
		   	
		   	case 'grid_no_space':
		   		include(DOTLIFE_ELEMENTOR_PATH.'/templates/blog-posts/grid_no_space.php');
		   	break;
		   	
		   	case 'masonry':
		   		include(DOTLIFE_ELEMENTOR_PATH.'/templates/blog-posts/masonry.php');
		   	break;
		   	
		   	case 'list':
		   		include(DOTLIFE_ELEMENTOR_PATH.'/templates/blog-posts/list.php');
		   	break;
		   	
		   	case 'list_circle':
		   		include(DOTLIFE_ELEMENTOR_PATH.'/templates/blog-posts/list_circle.php');
		   	break;
		   	
		   	case 'metro':
		   		include(DOTLIFE_ELEMENTOR_PATH.'/templates/blog-posts/metro.php');
		   	break;
		   	
		   	case 'metro_no_space':
		   		include(DOTLIFE_ELEMENTOR_PATH.'/templates/blog-posts/metro_no_space.php');
		   	break;
	   	}
...
<?php
	if($settings['show_pagination'] == 'yes')
	{
		...
		if($wp_query->max_num_pages > 1)
	    {
	    	...
	    	{
	    	    dotlife_pagination($wp_query->max_num_pages, 4, 'blog-posts-'.$settings['layout'] );
	    	}
	    	else
	    	{
?>
