<?php
	$blog_featured_image_size = 'dotlife-gallery-list';
		    ...
		    <div class="post_img static">
			    ...
			    <div class="post_img_hover <?php if(!empty($tg_enable_lazy_loading)) { ?>lazy<?php } ?>">
			     	<?php 
				     	...
				     	{
				     ?>
				     <img <?php echo dotlife_get_blank_img_attr(); ?> <?php echo esc_attr($return_attr['source']); ?>="<?php echo esc_url($blog_featured_img_url); ?>" class="lazy_masonry" alt="<?php echo esc_attr($blog_featured_img_alt); ?>"/>
				     <?php
					     }
					?>
